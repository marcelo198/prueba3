      ...
      <a class="navbar-brand" href="#">Inicio</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-item nav-link active" href="#">Crear</a>
        ...
        <div class="form-group">
          <form>
              <div class="form-group">
                ...
                <input type="email" name="situacion" class="form-control" id="situacion" aria-describedby="emailHelp" placeholder="Ingrese su situacion sentimental">
